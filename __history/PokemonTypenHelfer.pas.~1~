...
Own_Eis   =SEHR_EFFEKTIV+'Pflanze;Boden;Flug;Drache;'+NICHT_EFFEKTIV+'Feuer;Wasser;Eis';

Own_Kampf =SEHR_EFFEKTIV+'Normal;Eis;Gestein;Unlicht;Stahl;'+NICHT_EFFEKTIV+'Gift;Flug;Psycho;Käfer;Fee;'+KEINE_WIRKUNG+'Geist';

Own_Gift  =SEHR_EFFEKTIV+'Pflanze;Gift;'+NICHT_EFFEKTIV+'Gift;Boden;Gestein;Geist;'+KEINE_WIRKUNG+'Stahl';

Own_Boden =SEHR_EFFEKTIV+'Feuer;Elektro;Gift;'+NICHT_EFFEKTIV+'Pflanze;Käfer;'+KEINE_WIRKUNG+'Flug';
